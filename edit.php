...
<body>
         ...
         <form action="save.php?id=<?php print $andmed["id"]; ?>" method="post" enctype="multipart/form-data">
                ...
                Sugu: <input value="mmees" type="radio" name="sex" <?php print ($andmed["sex"] == "Mees" ? "checked" : ""); ?> >Mees
                          <input value="nnaine" type="radio" name="sex" <?php print ($andmed["sex"] == "Naine" ? "checked" : ""); ?> >Naine<br>
                Pilt:<br>
